package com.classicocomputers.gadsleaderboard.adapters;
...
public class SkillIQLeadersAdapter extends RecyclerView.Adapter<SkillIQLeadersAdapter.SkillIQViewHolder> {
    ...
    public SkillIQLeadersAdapter(Context context, List<SkillIQModel> skillIQModel) {
    ...
    public SkillIQViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = layoutInflater.inflate(R.layout.skill_iq_leaders_item, parent, false);
